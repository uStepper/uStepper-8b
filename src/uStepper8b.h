...
* @file uStepper8b.h
*
* @brief      Function prototypes and definitions for the uStepper 8b library
*
...
*	
*	This is the uStepper 8b Arduino library, providing software functions for the different features of the uStepper 8b board.
*
*	\par Features
*	The uStepper 8b library contains the following features:
*	
...
* 
*	\par Installation
*	To install the uStepper 8b library into the Arduino IDE, perform the following steps:
*
...
*	
*	The library is tested with Arduino IDE 2.3.7
*	
*	\warning MAC (and a few Windows) users should be aware, that in order to make the uStepper 8b show up in the "ports" list, you need to install the VCP driver from the following link:
*	\warning https://www.silabs.com/software-and-tools/usb-to-uart-bridge-vcp-drivers?tab=downloads
*
*	\par Theory
*
...
*	As a result, the position of the stepper motor will have continuous and differentiable first and second derivatives.
*
...
*	\image html dva.gif
*
*	From the above picture it can be seen how the motor moves with this second order acceleration profile. The position is depicted as orange, velocity as red and the acceleration as green.	
*
*	\par Copyright
*
*	(C) 2020 uStepper ApS	
 ...
 *             encoder on the uStepper 8b board. This class can be instantiated as
 *             a standalone object if all the features of the uStepper 8b is not
...
public:
	...
	* the motor shaft */
	 ...
	 *             reference position. When the uStepper 8b is first powered on,
...
/**
 * @brief      Prototype of class for accessing all features of the uStepper 8b in
 *             a single object.
 *
 *             This class enables the user of the library to access all features
 *             of the uStepper 8b board, by use of a single object.
 */
...
public:
	...
	*/
	...
	/** This variable is used to indicate which mode the uStepper 8b is
	...
	*/	
	...
	/**
	 * @brief      Constructor of uStepper 8b class
	 *
	 *             This is the constructor of the uStepper 8b class. This version
	 ...
	 */
	uStepper8b(float accel = 1000.0, float vel = 1000.0);
	...
	/**
	 * @brief      Initializes the different parts of the uStepper 8b object
	 *
	 *             This function initializes the different parts of the uStepper 8b
	 ...
	 *                              	"DROPIN" to configure the uStepper 8b to act as
	 ...
	 *				After tuning uStepper 8b the parameters are saved in EEPROM
	 *				
	 * 				Usage:
...
/** alias to have backwards compatibility for uStepper 8b */
using uStepperSLite = uStepper8b;
